...
useful without UI. Public hosting is an optional entry and coordination layer;
project data, browser execution, and media production remain local by default.
