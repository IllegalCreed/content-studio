  ...
  it('把活动、内容组和人工交接整理成活动详情投影', () => {
    ...
    const handoff: OwnerHandoff = {
      ...
      marketingOpsConfirmation: {
        publicUrl: 'https://www.bilibili.com/opus/900000000000000001',
        status: 'pending',
      },
      marketingOpsPackage: {
        ...
        activityId: 'activity-a',
        artifactRefs: [],
        body: 'Synthetic Bilibili short post',
        campaignId: 'activity-a',
        channel: 'bilibili',
        contentFormat: 'short-post',
        contentHash: 'a'.repeat(64),
        contentId: 'content-bilibili-a',
        contentVersion: 1,
        locale: 'zh-CN',
        ...
        renderer: {
          canonicalUrl: 'https://example.com/activity-a/',
          format: 'post',
          links: [],
          media: [],
          utmMedium: 'social',
        ...
        schemaVersion: 1,
        title: 'Synthetic Bilibili short post',
      },
